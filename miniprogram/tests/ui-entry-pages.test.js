...
assert.doesNotMatch(loginWxml, /brand-icon-shell|<ui-icon\s+name="plan"\s+shape="orbit"/)
...
assert.doesNotMatch(homeWxml, /welcome-mark|<ui-icon\s+name="plan"\s+shape="orbit"/)
