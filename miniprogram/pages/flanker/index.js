...
registerPatientPage({
  ...
  _recordAnswer(answer, elapsed) { clearTimers(this); this._records.push(evaluateFlankerTrial(this._trials[this._index], answer, elapsed)); this._index += 1; this.setData({ progressPercent: Math.round((this._index / this._trials.length) * 100) }); if (this._index >= this._trials.length) return this._completeTest(); this.setData({ phase: 'feedback' }); schedule(this, () => this._showTrial(), 250) },
